    ...
    <div class="container-fluid displaying-event">
        ...
        <div class="row content">
            ...
            <div class="col-md-6 associationText">
                ...
                <div>
                    <button class="reactionButton">Like</button>
                    <button class="reactionButton">Dislike</button>
                    <a href="association.php">Accéder à l'association</a>
                </div>
            </div>
        </div>
        ...
        <div class="row reverseContent">
            ...
            <div class="col-md-5 associationText">
                ...
                <div><a href="association.php">Accéder à l'association</a></div>
            </div>
        </div>
