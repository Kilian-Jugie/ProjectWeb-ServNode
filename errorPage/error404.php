...
<body>
    ...
    <div class="container-fluid">
        <div class="content">
            <a href="../index.php"><button type="button" class="btn btn-warning">Go back</button></a>
            <div>
                <img src="../src/img/errorImage/error404Image.png" alt="imgContact" class="error403Img">
            </div>
            <div class="digit">
