<div class="container-fluid header-shop">
    <div class="row">
        <div class="col-md-4 pos-logo-shop">
            <a href="../shop/shopIndex.php"><img src="../src/img/cesiBlancTransp.png" alt="image du logo de cesi mais en blanc" /></a>
        </div>
        <div class="col-md-4 pos-nav-menu-shop">
            <span><a href="../shop/shopMen.php">HOMME</a></span>
            <span><a href="../shop/shopFemme.php">FEMME</a></span>
            <span><a href="../shop/stores.php">STORES</a></span>
